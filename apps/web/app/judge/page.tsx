          ...
          <table className="judge-table">
            <tbody>
              ...
              <tr>
                <th>Tests</th>
                <td>
                  <strong>245 vitest tests</strong> (unit, end-to-end on a fake Nansen, one replay per fixture, key-boundary) · <strong>13/13 recorded plans reproduce offline</strong> byte-for-byte
                </td>
              </tr>
              <tr>
...
npm test              # 245 tests incl. 60,000 property cases
