...
export default function JudgePage() {
  return (
    <main className="judge">
      <h1>For the judge</h1>
      <p className="lede">Everything below is verifiable in the repo or on the live app. No account, no wallet, no key needed to read this page or to click the path.</p>

      <section>
        <h2>The claim</h2>
        <p className="claim">{CLAIM}</p>
        <p className="tiny muted">Nansen labels decide what counts as organic. It plans; it never trades.</p>
      </section>
      ...
      <section>
        ...
        <ol>
          ...
          <li>
            Open the <strong>provenance drawer</strong> under the plan — every Nansen call, the fields used, credits from the response headers, cached or live, and milliseconds.
          </li>
          <li>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                liquidity; a red today halves tranche 1 and only tranche 1; consecutive UTC dates, ≤ 90 of them, expectedDays ≥ days ≥ 1; the decision hash is deterministic and invariant to timing and
                context fields. It found one real defect (a zero-token tranche emitted 90 empty rows) — fixed and pinned.
              </td>
            </tr>
            <tr>
              <th>E2E</th>
              <td>
                4 Playwright suites (home, planner flow, responsive 375/768/1440, this page) — run in CI with no key; the built app is asserted to never contain an <code>nsn_</code> key
              </td>
            </tr>
            <tr>
              <th>Clean clone</th>
      ...
      <section>
        <h2>Reproduce</h2>
        <p className="tiny muted">The real path — live Nansen, real credits:</p>
...
npm run check         # submission-readiness audit`}</pre>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            <strong>A slow Nansen day is visible.</strong> Cold plans take 2–10 s; the organic-breadth page has a 12 s ceiling and timed out once in review (plan took 14.8 s with a red &ldquo;failed:
            timeout&rdquo; provenance row, concentration not applied). Failures are never cached and never invented — the term is null and the warning names the endpoint.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <div className="links">
          ...
          <a className="btn ghost" href={`${REPO}/blob/main/DEMO.md`}>
        ...
        <p className="tiny muted">Built for the Nansen Meridian Buildathon (14–27 Sep 2026). Not financial advice.</p>
      </section>
    </main>
  );
}
